    ...
    return (
        <div className={'root-container'}>
                    ...
                    {localStorage.getItem('SESSION-ID') &&
                        <div className={'profile'}>
                            ...
                            <div className={'profile-menu'}>
                                ...
                                <Link className={'profile-nav-links'}
                                      to={`/profile/${localStorage.getItem('SESSION-ID')}/personal-info`}>
            ...
            <section className={'root-footer'}>
                ...
                {currentUser.email === '' &&
                    <div className={'footer-subscribe-form'}>
                        <Typography variant={'h5'}
                                    className={'footer-subscribe-form-title'}>{t('footer.subscribe.title')}</Typography>
                        <FormControl variant="standard">
                            <Stack direction={'row'} alignItems={'center'}>
                                ...
                                />
                                <Button sx={{
                                    height: 'fit-content%', borderRadius: 0
                                }} variant={'contained'}>{t('footer.subscribe.button')}</Button>
                            </Stack>
                        </FormControl>
                    </div>
                }
                <div className={'footer-links-wrapper'} style={{width: props.language === 'vi' ? '80%' : '55%'}}>
                    <div>
                ...
                <Stack className={'footer-end'} direction={'row'} alignItems={'center'} width={'80%'} marginBlock={'5rem 1rem'}>
            ...
            <div className={'chat-help-wrapper'}>
                {
                    openChat ?  <ChatPanel onClose={() => setOpenChat(false)}/>
                        : <ChatIcon className={'chat-help-btn'} onClick={() => setOpenChat(true)} sx={{fontSize: '3.5rem'}}/>
                }
            </div>
        </div>
    )
