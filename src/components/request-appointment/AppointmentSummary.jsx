        ...
        <div className={'appointment-confirmation-wrapper'}>
            ...
            {location.pathname.includes("/payment") &&
                <Stack direction={'row'} justifyContent={'space-between'}>
                    <Typography level={'h4'} sx={{color: '#919191'}}>{t('component.appointment_summary.status')}</Typography>
            ...
            <div style={appointmentData.reason.length < 30 ? {display: 'flex', justifyContent: 'space-between'} : {}}>
                <Typography level={'h4'} sx={{color: '#919191'}}>{t('component.appointment_summary.reason')}</Typography>
                <Typography level={'body-lg'} sx={{color: 'white', overflow: 'hidden', textOverflow: 'clip'}}>
                    {appointmentData.reason || "empty"}
                </Typography>
            </div>
            <div>
                <Typography level={'h4'} sx={{color: '#919191'}}>{t('component.appointment_summary.provider')}</Typography>
